...
def api_lowprice(user: User) -> None:
    """
    Осуществляет запрос информации у API, применяет к полученным данным алгоритм сортировки по самой низкой цене,
    ...
    try:
        ...
        logger.info('Lowprice request for user: {user_id} ended successfully'.format(user_id=user.USER_ID))
